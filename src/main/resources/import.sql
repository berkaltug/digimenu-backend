...
insert into menu(id,item,ingredients,price,restaurant_id,category,is_active,is_favourite,rating,vote_count,image_public_id) values (-3,'ciğer sarma','dana ciğer,lavaş',15.45,1,'Ana Yemek',true,false,0,0,'tdlizx0l0ktr4op9ljgo');
insert into menu(id,item,ingredients,price,restaurant_id,category,is_active,is_favourite,rating,vote_count,image_public_id) values (-4,'Izgara Köfte','dana kıyma,maydanoz,biber',16.56,1,'Ana Yemek',true,false,0,0,'thomavgirykdp7qxt3oj');
